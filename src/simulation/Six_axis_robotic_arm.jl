...
function Koch_simulation_model(vis::MeshCat.AbstractVisualizer)
...
function redball_simulation_model(vis::MeshCat.AbstractVisualizer, q_ball::AbstractVector{<:Real})
